...
import iterator.ExtendedIteratorClass;
...
public class BLFacadeImplementation  implements BLFacade {
   ...
   public Question createQuestion(Event event, String question, float betMinimum) throws EventFinished, QuestionAlreadyExist{
	...
	public ExtendedIterator<Event> getEvents(Date date)  {
		...
		dbManager.close();
		//ExtendedIteratorClass ev = new ExtendedIteratorClass(events);
		return events;
	}
	...
	public Registered getRegisteredFromUser(User u) {
		dbManager.open(false);
		Registered r = dbManager.getRegisteredFromUser(u);
		dbManager.close();
		return r;
	}
}
