...
public class RegisteredGUI extends JFrame {
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			jContentPane.add(getButtonApustuGuztiak());
		}
		return jContentPane;
	}
	private JButton getButtonApustuGuztiak() {
		JButton buttonApustuGuztiak = new JButton("Table of "+user.getUsername());
		buttonApustuGuztiak.setFont(new Font("Tahoma", Font.PLAIN, 16));
		buttonApustuGuztiak.setForeground(Color.DARK_GRAY);
		buttonApustuGuztiak.setBackground(Color.PINK);
		buttonApustuGuztiak.setOpaque(true);
		buttonApustuGuztiak.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JFrame a = new ApustuGuztiakGUI(user);
				a.setVisible(true);
				
			}
		});
		buttonApustuGuztiak.setBounds(10, 485, 282, 68);
		return buttonApustuGuztiak;
	}
